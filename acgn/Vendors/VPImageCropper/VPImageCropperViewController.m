...
- (void)initView {
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, DMScreenWidth, DMScreenHeight)];
...
- (void)initControlBtn {
    ...
    UIView *tView = [[UIView alloc] initWithFrame:CGRectMake(0, 0.0f, DMScreenWidth, NavigationBarHeight+StatusBarHeight)];
    tView.backgroundColor = [UIColor blackColor];
    [self.view addSubview:tView];
    
    UIView *bView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 50.0f, DMScreenWidth, 50)];
